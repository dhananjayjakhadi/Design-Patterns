...
public class ModerateRiskI implements AirportStateI {
    ...
    ModerateRiskI(SecurityFactors sf) {
        this.sf = sf;
        MyLogger.writeMessage("ModerateRiskI constructor", MyLogger.DebugLevel.CONSTRUCTOR);
    }
